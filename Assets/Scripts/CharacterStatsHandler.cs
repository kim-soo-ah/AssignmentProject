...
public class CharacterStatsHandler : MonoBehaviour
{
    ...
    private const float MinJumpPower = 0.8f;
    ...
    private void UpdateStats(Func<float, float, float> operation, CharacterStats newModifier)
    {
        ...
        CurrentStats.jumpPower = operation(CurrentStats.jumpPower, newModifier.jumpPower);
    ...
    private void LimitAllStats()
    {
        ...
        LimitStats(ref CurrentStats.jumpPower, MinJumpPower);
